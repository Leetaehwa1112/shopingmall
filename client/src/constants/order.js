...
export const ORDER_STATUS = {
  pending_payment: { label: '결제 대기',  led: 'yellow', color: 'text-amber-700  bg-amber-50  border-amber-200',  step: 0  },
  ...
  shipped:         { label: '운송중',     led: 'blue',   color: 'text-indigo-700  bg-indigo-50  border-indigo-200',  step: 3  },
...
export const ORDER_PROGRESS_STEPS = ['주문 확정', '결제 완료', '배송 준비', '운송중', '도착']

// 취소 가능 / 환불 가능 상태
export const CANCELLABLE_STATUSES = ['pending_payment', 'paid', 'preparing']
export const REFUNDABLE_STATUSES  = ['paid', 'delivered']

// 필터 탭 (전체 + 모든 상태)
export const ORDER_FILTERS = [
  { value: 'all',             label: '전체',     led: null     },
  { value: 'pending_payment', label: '결제 대기', led: 'yellow' },
  { value: 'paid',            label: '결제 완료', led: 'green'  },
  { value: 'preparing',       label: '배송 준비', led: 'blue'   },
  { value: 'shipped',         label: '운송중',   led: 'blue'   },
  { value: 'delivered',       label: '도착',     led: 'green'  },
