...
const CONTENT = {
  support: {
    ...
    intro: '평일 10:00–19:00 · 점심 12:30–13:30 제외',
    sections: [
      { h: '연락 채널',
        body: [
          ['전화', '1588-0420 (평일 10–19시)'],
      ...
      { h: '응대 안내',
        body: [
          ...
          ['에스크로 거래', '₩1,000,000 이상 주문은 안전결제 자동 적용'],
          ['고액 거래 전담', '₩30,000,000 이상 Brink\'s 무장 호송 전담 라인 별도 안내'],
        ],
      },
      { h: '주말/공휴일',
        body: [
  ...
  shipping: {
    title: '배송 안내',
    eyebrow: 'SHIPPING · 트래킹 + 서명 필수',
    intro: '모든 발송은 트래킹 + 수령인 서명 필수. 분실/파손 시 전액 보상.',
    sections: [
      { h: '배송 옵션 (카드)',
        body: [
          ['일반 배송 (CJ대한통운)', '평일 1-2일 · 기본 보험'],
          ['FedEx Priority Insured', '평일 1-2일 · 전액 보험 · 서명 필수 · ₩30,000'],
          ['Brink\'s Armored', '24-48시간 · 무장 운송 2인 · ₩1,500,000'],
          ['직접 수령 (강남 본사)', '평일 10-19시 · 본인 확인 필수 · 무료'],
        ],
      },
      { h: '배송 옵션 (카드팩 전용)',
        body: [
          ['퀵 배송 (당일)', '서울·경기 한정 · 2-4시간 도착 · 거리/지역에 따라 결제 단계에서 산정'],
        ],
      },
      { h: '고가 거래 배송 등급',
        body: [
          ['₩5,000,000 이상', 'FedEx Insured 권장 (Brink\'s 선택 가능)'],
          ['₩30,000,000 이상', 'Brink\'s 권장 (FedEx Insured 선택 가능)'],
          ['₩100,000,000 이상', 'Brink\'s 의무 적용'],
        ],
      },
      { h: '패키징',
        body: [
  ...
  faq: {
    ...
    faq: [
      ...
      { q: '퀵 배송 비용은 얼마인가요?',
        a: '퀵 배송은 카드팩 전용 옵션으로 서울·경기 한정 2-4시간 내 도착합니다. 출발지와 도착지 거리·시간대에 따라 변동되며, 정확한 금액은 주문/결제 단계에서 산정·표시됩니다.' },
      { q: '해외 배송 가능한가요?',
      ...
      { q: '카드 상태를 직접 확인할 수 있나요?',
        a: '서울 강남 본사에서 사전 예약 후 실물 확인 가능 (평일 10:00–19:00, 점심 12:30–13:30 제외). 1588-0420으로 문의주세요.' },
    ],
  },
  about: {
    title: '회사 소개',
