      ...
      <PageHeader
        ...
        actions={
          <>
            ...
            <button onClick={() => navigate('/admin/products/new')} className="inline-flex items-center gap-1.5 text-xs font-bold bg-ink text-paper px-3 py-1.5 rounded-md hover:bg-ink/90">
