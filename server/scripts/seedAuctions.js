...
const MOCK_AUCTIONS = [
  {
    ...
    name: 'Charizard',
    nameKo: '리자몽',
    photos: ['https://images.pokemontcg.io/base1/4_hires.png'],
  ...
  },
  {
    ...
    nameKo: '피카츄 일러스트레이터',
    photos: ['https://images.pokemontcg.io/base1/58_hires.png'],
  ...
  },
  {
    ...
    nameKo: '샤이닝 리자몽',
    photos: ['https://images.pokemontcg.io/neo4/107_hires.png'],
    set: 'Neo Destiny',
    year: '2001',
    number: '107/105',
    gradeCompany: 'BGS',
  ...
  },
  {
    ...
    name: 'Lugia',
    nameKo: '루기아',
    photos: ['https://images.pokemontcg.io/neo1/9_hires.png'],
